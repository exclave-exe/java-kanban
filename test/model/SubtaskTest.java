...
class SubtaskTest {
    ...
    public void subtasksShouldBeEqualIfAllFieldsMatch() {
        ...
        Subtask subtask1 = new Subtask(5, epic, "test", "test", Status.NEW);
        Subtask subtask2 = new Subtask(5, epic, "test", "test", Status.NEW);
    ...
    public void shouldReturnCorrectParentId() {
        // Arrange
        Epic epic = new Epic(1, "test", "test");
        Subtask subtask = new Subtask(2, epic, "test", "test", Status.NEW);
